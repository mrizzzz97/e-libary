...
@section('konten')
    ...
    <section class="py-10 sm:py-16 lg:py-24">
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            ...
            <div class="grid max-w-md grid-cols-1 mx-auto mt-12 
                        lg:max-w-full lg:mt-16 lg:grid-cols-3 
                        gap-x-16 gap-y-12">
                ...
                @foreach ($books as $book)
                    <div>
                        ...
                        {{-- category --}}
                        <span class="inline-flex px-4 py-2 text-xs font-semibold tracking-widest uppercase rounded-full mt-9 {{ $book->category_color }}">
                            {{ $book->category->name }}
                        </span>

                        {{-- title --}}
                        <p class="mt-6 text-xl font-semibold">
                            <a href="/hall/book/{{ $book->slug }}" class="text-black">
                                {{ $book->name }}
                            </a>
                        </p>
