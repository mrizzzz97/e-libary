            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/hall"
                            class="rounded-md px-3 py-2 text-sm font-medium {{ request()->is('hall*') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">Hall</a>
                            
                        @auth
                            <a href="/borrow/{{ auth()->user()->slug }}" 
                                class="rounded-md px-3 py-2 text-sm font-medium {{ request()->is('borrow*') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">My Borrows</a>
                        @endauth
    ...
    @auth
        <div x-show="isOpen" class="md:hidden" id="mobile-menu">
            <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                ...
                @auth
                    <a href="/borrow/{{ auth()->user()->slug }}"
                        class="block rounded-md px-3 py-2 text-base font-medium {{ request()->is('borrow*') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">My Borrows</a>
                @endauth
